<script lang="ts">
	import Partner from './partners/Partner.svelte'
</script>

<section
	id="partenaires"
	class="mx-auto flex max-w-screen-3xl scroll-mt-10 flex-col gap-10 px-6 py-20 md:scroll-mt-24 md:gap-16 md:px-20"
>

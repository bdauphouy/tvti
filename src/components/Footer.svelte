		...
		<div class="flex flex-col gap-10 md:flex-row md:items-end md:gap-40">
			<div class="flex flex-col gap-4">
				...
				<ul class="flex flex-col gap-1 text-lg text-gray">
					...
					<li>
						<a href="tel:0614881054">0614881054</a>
					</li>
					<li>
						<a href="mailto:sebastien.tvti@sfr.fr">sebastien.tvti@sfr.fr</a>
					</li>
				</ul>
			</div>
			<ul class="flex flex-col gap-1 text-lg text-gray">
				...
				<li>
					<a href="/mentions-legales.pdf">Mentions légales</a>
				</li>
			</ul>
		</div>
		<div class="flex flex-col justify-between gap-4 text-lg text-white sm:flex-row">
			<span>Réalisé avec ❤️ par son fils</span>
